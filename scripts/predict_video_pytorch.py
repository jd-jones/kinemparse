...
class VideoDataset(sim2real.PickledVideoDataset):
    pass
...
def main(
    ...
    data_loader = VideoLoader(trial_ids, data_dir, vocab=vocab, label_fn_format='assembly-seq')
    ...
    def make_dataset(labels, ids, batch_mode='sample', shuffle=True):
        dataset = Dataset(
            vocab, data_loader.loadData, labels,
